          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-ink-800 border border-white/5 p-8 relative overflow-hidden group hover:border-signal/40 hover:scale-[1.01] transition-all duration-500 hover:bg-ink-800/80 flex flex-col justify-between scroll-mt-32"
                data-cursor="hover"
              >
                ...
                <div className="relative z-10 mb-8">
                  <div className="flex justify-between items-start w-full mb-8">
                    ...
                    <div className="flex items-center gap-3">
                      {service.badge && (
                        <span className="font-mono text-[10px] uppercase tracking-widest bg-signal text-ink-950 px-3 py-1 rounded-full font-bold">
                          {service.badge}
                        </span>
                      )}
                ...
                <div className="relative z-10">
                  {isPreview ? (
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 bg-signal text-ink-950 font-display font-medium px-6 py-2.5 rounded-full text-sm hover:shadow-[0_0_20px_rgba(255,165,0,0.35)] transition-all"
                      data-cursor="hover"
                    >
                      Contratar
                    </a>
