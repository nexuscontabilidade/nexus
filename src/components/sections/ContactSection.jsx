  ...
  return (
    <div onFocus={() => setFocused(true)} onBlur={() => setFocused(false)}>
      <motion.span
        ...
        animate={{ color: focused ? '#FFA500' : '#B0B0B0', y: focused ? -2 : 0 }}
...
const fieldInputClass = 'w-full bg-ink-900 border border-white/10 rounded-lg px-4 py-3 text-white outline-none transition-colors focus:border-signal focus:ring-2 focus:ring-signal/10'
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <ScrollReveal className="lg:col-span-3">
              <div className="bg-ink-800 border border-white/5 rounded-2xl p-8 md:p-10">
                ...
                >
                  ...
                  <MagneticButton
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center justify-center gap-3 bg-signal text-ink-950 font-display font-medium px-8 py-4 rounded-full text-lg hover:shadow-[0_0_30px_rgba(255,165,0,0.35)] transition-all disabled:opacity-60 mt-2"
                  >
            ...
            <ScrollReveal delay={0.15} className="lg:col-span-2">
              <div className="bg-ink-800 border border-white/5 rounded-2xl p-8 md:p-10 h-full flex flex-col">
                ...
                <div className="flex flex-col gap-5 mb-10">
                  <a href={`mailto:${contactInfo.email}`} className="flex items-start gap-4 group" data-cursor="hover">
                    <div className="w-11 h-11 rounded-full bg-ink-900 border border-white/10 flex items-center justify-center shrink-0 group-hover:border-signal/40 transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 rounded-full bg-ink-900 border border-white/10 flex items-center justify-center shrink-0">
                ...
                <div className="mt-auto pt-6 border-t border-white/5">
                  ...
                  <a href={contactInfo.instagram} target="_blank" rel="noreferrer" className="inline-flex w-11 h-11 rounded-full bg-ink-900 border border-white/10 items-center justify-center hover:border-signal/40 transition-colors" data-cursor="hover">
