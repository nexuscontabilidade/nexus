        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-24">
          ...
          <div className="col-span-1 border-r-0 md:border-r md:border-white/5 pr-8">
            ...
            <div className="flex gap-4 text-mist-900">
              <a href={contactInfo.instagram} target="_blank" rel="noreferrer" className="hover:text-white transition-colors p-2 -ml-2 rounded-full hover:bg-white/5" data-cursor="hover">
          ...
          <div className="col-span-1">
            ...
            <ul className="flex flex-col gap-4 text-sm text-mist-500">
              <li><Link to="/servicos#contabilidade-digital" className="hover:text-white transition-colors" data-cursor="text">Contabilidade Digital</Link></li>
              <li><Link to="/servicos#planejamento-tributario" className="hover:text-white transition-colors" data-cursor="text">Planejamento Tributário</Link></li>
              <li><Link to="/servicos#abertura-empresas" className="hover:text-white transition-colors" data-cursor="text">Abertura de Empresas</Link></li>
              <li><Link to="/servicos#certificado-digital" className="hover:text-white transition-colors" data-cursor="text">Certificado Digital</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="flex flex-col gap-4 text-sm text-mist-500">
              <li><Link to="/sobre" className="hover:text-white transition-colors" data-cursor="text">Sobre Nós</Link></li>
              <li><Link to="/contato" className="hover:text-white transition-colors" data-cursor="text">Contato</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex flex-col gap-4 text-sm text-mist-500">
              <a href={`https://wa.me/${contactInfo.whatsappNumber}`} target="_blank" rel="noreferrer" className="hover:text-white transition-colors flex items-center gap-2" data-cursor="hover">
                <Phone size={14} className="text-signal" /> {contactInfo.whatsappDisplay}
              </a>
              <a href={`mailto:${contactInfo.email}`} className="hover:text-white transition-colors flex items-center gap-2" data-cursor="hover">
